...
#+keywords: lisp swift optional scala simple optionals switch chaining for pattern matching clojure haskell
...
So Wall Street contacted you, they need a new trading platform running on iOS devices. You're in for the money of course, so you start developing. As it is a trading platform, you define an =enum= for trades.
...
This completes list of possible switch patterns. But, what else can we do with pattern matching? Here're some more useful real world examples:
